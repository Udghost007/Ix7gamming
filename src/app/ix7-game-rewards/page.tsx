...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://ix7gaming.com/ix7-game-rewards",
  ...
  alternates: { canonical: "https://ix7gaming.com/ix7-game-rewards" },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "IX7 Game Rewards", item: "https://ix7gaming.com/ix7-game-rewards" },
  ],
};
