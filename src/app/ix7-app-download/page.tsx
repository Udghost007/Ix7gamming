...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://ix7gaming.com/ix7-app-download",
  ...
  alternates: { canonical: "https://ix7gaming.com/ix7-app-download" },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "IX7 App Download", item: "https://ix7gaming.com/ix7-app-download" },
  ],
};
