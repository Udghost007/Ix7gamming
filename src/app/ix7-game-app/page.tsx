...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://ix7gaming.com/ix7-game-app",
  ...
  alternates: { canonical: "https://ix7gaming.com/ix7-game-app" },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "IX7 Game App", item: "https://ix7gaming.com/ix7-game-app" },
  ],
};
