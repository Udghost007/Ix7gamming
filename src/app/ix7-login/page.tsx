...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://ix7gaming.com/ix7-login",
  ...
  alternates: { canonical: "https://ix7gaming.com/ix7-login" },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "IX7 Login", item: "https://ix7gaming.com/ix7-login" },
  ],
};
